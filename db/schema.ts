...
export const dataSnapshots = sqliteTable("data_snapshots", {
  ...
  metric: text("metric", { enum: ["trade", "price", "price_retail", "logistics", "production", "macro", "search_query_health", "source_health"] }).notNull(),
