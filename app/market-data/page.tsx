...
export default function MarketDataPage() {
  return <ProductShell><div className="data-site">
    <main>
      ...
      <section className="data-block pale" id="mirror"><div className="data-heading"><div><span>02 · MIRROR CHECK</span><h2>中国出口 × 中亚进口交叉核验</h2></div><p>先按中亚五国分组，再按菌类品类分别核验。进口国缺报时继续展示中国出口镜像，并明确证据等级。</p></div><MirrorLiveGrid /><p className="data-footnote">差异率仅在两侧数据同时存在时计算；单侧数据用于证明贸易活动与量级，不冒充进口国正式统计。</p></section>
