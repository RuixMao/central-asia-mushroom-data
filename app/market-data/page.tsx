...
export default function MarketDataPage() {
  return <ProductShell><div className="data-site">
    <main>
      ...
      <section className="data-block pale" id="mirror"><div className="data-heading"><div><span>02 · TRADE COMPARISON</span><h2>中国出口与中亚进口对比</h2></div><p>按国家和菌类品类展示双方公开贸易金额，帮助判断市场规模、贸易方向及统计差异。</p></div><MirrorLiveGrid /><p className="data-footnote">两地统计可能因计价方式、运输时间及转口贸易产生差异；缺少当地数据时，仅展示中国公布的出口金额。</p></section>
