...
export default function MarketDataPage() {
  return <ProductShell><div className="data-site">
    <main>
      <section className="data-hero"><span>YINHENG MARKET DATA</span><h1>菌业出海<br />公开市场数据</h1><p>将官方贸易、农业生产与市场挂牌信息按统一字段整理，并保留来源、时间、统计口径和缺失状态。</p><div><b>数据基线：2022–2024</b><b>页面更新：2026-08-30</b><b>覆盖：中亚五国贸易 + 东南亚价格</b></div></section>
      ...
      <section className="data-block pale" id="mirror"><div className="data-heading"><div><span>02 · TRADE COMPARISON</span><h2>中国出口与目标市场进口对比</h2></div><p>按国家和菌类品类展示 2024 年公开贸易金额，并以 A+、A、B+、B 标注资料完整度。</p></div><MirrorLiveGrid /><p className="data-footnote">A+ 表示进口国公布了金额、数量和来源国；B+ 表示已汇总两个或以上伙伴国的出口申报。金额均为美元。</p></section>
      ...
      <section className="data-sources" id="sources"><div><span>04 · DATA SOURCES</span><h2>数据来源</h2><p>贸易、生产和价格信息来自各国官方机构及国际数据库，并保留发布日期和统计口径，便于复核。</p></div><div><a href="https://english.customs.gov.cn/Statistics/Statistics" target="_blank" rel="noreferrer"><b>01</b><span>中国海关统计<small>中国与菌业出海目标市场进出口数据</small></span></a><a href="https://www.stat.tj/ru/" target="_blank" rel="noreferrer"><b>02</b><span>塔吉克斯坦国家统计局<small>对外贸易及国内市场统计</small></span></a><a href="https://stat.gov.tm/en" target="_blank" rel="noreferrer"><b>03</b><span>土库曼斯坦国家统计委员会<small>外贸、农业和国内贸易统计</small></span></a><a href="https://comtradeapi.un.org" target="_blank" rel="noreferrer"><b>04</b><span>联合国商品贸易数据库<small>各国贸易数据的统一查询与比较</small></span></a><a href="https://www.fao.org/faostat" target="_blank" rel="noreferrer"><b>05</b><span>联合国粮农组织数据库<small>农业生产与供给结构</small></span></a></div></section>
      <section className="data-cta"><div><span>DATA SERVICE</span><h2>需要完整数据、字段字典或专项研究？</h2></div><Link href="/expand/contact">申请完整数据 →</Link></section>
    </main>
  </div></ProductShell>;
}
