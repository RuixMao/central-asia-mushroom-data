...
export default function MarketDataPage() {
  return <div className="data-site">
    ...
    <main>
      ...
      <section className="data-block" id="price"><div className="data-heading"><div><span>03 · MARKET PRICE</span><h2>食用菌价格监测</h2></div><p>按国家与菌种筛选；挂牌价并非实际成交价，缺失记录明确显示采集缺口。</p></div><PriceLiveTable /></section>
