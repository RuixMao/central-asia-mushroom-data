...
export default function OpportunitiesPage(){return <ProductShell><main className="saas-main">
  ...
  <OpportunityRadar/>
  <section className="page-cta radar-cta"><div><span>NEXT STEP</span><h2>把信号转成目标市场验证任务</h2><p>核验价格与贸易证据，或提交产品、目标国家和合作需求。</p></div><div><a href="/terminal">查看数据依据 →</a><a href="/expand/contact">提交合作需求 →</a></div></section>
</main></ProductShell>}
