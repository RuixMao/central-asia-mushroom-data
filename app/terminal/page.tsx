...
const readyAssets = [
  ...
  {
    title: "乌兹别克斯坦食用菌产量",
    coverage: "全国及14个地区 · 2018–2024",
    cadence: "年度",
    state: "已发现",
    value: "本地产能、进口依赖、区域生产地图",
    url: "https://api.siat.stat.uz/media/uploads/sdmx/sdmx_data_519.pdf",
  },
  {
  ...
  return (
    <div className="intel-app">
      ...
      <main className="intel-main">
        ...
        {view === "market" ? (
          <MarketPanel onState={setLiveState} />
        ) : (
          <>
            <section className="intel-hero asset-hero">
              <div>
                <span>DATA ASSET MAP</span>
                <h1>把公开数据变成连续商业资产</h1>
                <p>
                  贸易统计回答市场规模，月度序列捕捉变化，日度采集补足价格和渠道信号。
                </p>
              </div>
              ...
              <div className="ready-grid">
                {readyAssets.map((asset) => (
                  ...
                  >
                    ...
                    <b>商业用途：{asset.value}</b>
                  </a>
                ))}
              </div>
            </section>
            <section className="asset-section dark-assets">
              <div className="asset-title">
                <span>02 / PROPRIETARY SIGNALS</span>
                <h2>下一阶段持续采集</h2>
              </div>
              <div className="signal-list">
                {signals.map(([priority, title, fields, product, score]) => (
