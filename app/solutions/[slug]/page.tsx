...
const solutions = {
  ...
  professional: { label: "专业服务机构", en: "PROFESSIONAL SERVICES", headline: "为咨询、法律、审计与产业服务补齐中亚事实底座", intro: "以结构化数据和可追溯证据，提升客户项目的研究效率与交付质量。", needs: ["快速行业扫描", "企业与项目事实核验", "市场证据与数据引用", "客户报告的数据支持"], deliverables: ["项目级数据包", "企业及市场快速调查", "图表与数据附录", "持续数据支持服务"] },
  academic: { label: "高校与学术研究", en: "UNIVERSITIES & ACADEMIA", headline: "让中亚研究拥有可复现、可引用、可持续的数据基础", intro: "面向高校、实验室、课题组和研究生项目，支持区域经济、国际贸易、农业产业与数据科学研究。", needs: ["论文与课题数据获取", "跨国长期序列比较", "数据方法与口径说明", "产学研及联合研究"], deliverables: ["研究级数据集与数据字典", "来源、版本和引用信息", "可复现分析样例", "联合课题与学生实践项目"] },
} as const;
