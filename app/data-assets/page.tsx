...
const capabilities=[
  {status:"已上线",title:"官方贸易与市场规模",scope:"10个目标市场；HS 070951、070959、200310",source:"UN Comtrade、各国海关与伙伴国镜像",cadence:"年度及月度更新",delivery:"国别规模、品类结构、来源口径与证据等级"},
  {status:"已上线",title:"跨区域公开价格监测",scope:"中亚与东南亚主要城市、已接入零售与电商渠道",source:"公开商品页与平台搜索页",cadence:"每日采集",delivery:"SKU 明细、原币价格、USD/kg、规格和来源页"},
  {status:"已上线",title:"市场报告与商机信号",scope:"目标市场食用菌价格、贸易与已核验证据",source:"平台数据、公开资料与报告证据包",cadence:"日报及专题更新",delivery:"结论、证据、风险与关键验证条件"},
  {status:"可申请",title:"国别市场进入研究",scope:"覆盖中亚、东南亚及新增目标市场",source:"贸易、价格、渠道观察与公开准入资料",cadence:"按研究周期更新",delivery:"市场判断、风险清单与验证建议"},
