...
export default function CorporateHome(){return <div className="marketing-site decision-home">
  ...
  <main>
    ...
    <section className="decision-action"><div><span>NEXT STEP</span><h2>选择目标市场，推进产品验证</h2><p>查看国别机会与风险，提交产品、产能和目标国家，获取市场验证清单。</p></div><div><a href="/countries/kz">查看哈萨克斯坦市场</a><a href="/expand/contact">提交目标市场</a><a href="/opportunities">申请市场验证</a></div></section>
  </main>
  <MarketingFooter/>
</div>}
