...
export default function CorporateHome(){
  ...
  return <div className="corp-site">
    ...
    <footer className="corp-footer"><div className="footer-brand"><Image className="footer-logo-image" src="/inhen-tech-logo.png" alt="因恒科技 Inhen Tech" width={282} height={90} /><p>面向国际投资者、金融机构、企业管理者和研究人员的中亚金融与商业情报平台。</p></div><div><b>产品</b><a href="#products">市场信息</a><a href="/market-data">区域数据中心</a><a href="#products">研究与咨询</a></div><div><b>解决方案</b><a href="#solutions">金融机构</a><a href="#solutions">跨境投资者</a><a href="#solutions">国际贸易企业</a></div><div><b>联系</b><a href="#contact">申请演示</a><a href="#contact">联系我们</a><a href="#insights">市场洞察</a></div><div><b>法律</b><a href="/privacy">隐私政策</a><a href="/terms">使用条款</a><span>情报终端 · 即将推出</span></div><div className="footer-bottom"><span>© 2026 因恒科技</span><span>公开信息仅供研究参考，不构成投资或交易建议。</span></div></footer>
  </div>
}
