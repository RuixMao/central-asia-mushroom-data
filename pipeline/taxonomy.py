...
SPECIES={
 ...
 "enoki":["эноки","enoki","enokitake","nấm kim châm","เห็ดเข็มทอง","金针菇"],"shiitake":["шиитаке","шиитаки","shiitake","shitake","siitake","sitake","nấm hương","nấm đông cô","เห็ดหอม","ເຫັດຫອມ","香菇"],"king_oyster_mushroom":["королевская вешенка","king oyster mushroom","king trumpet mushroom","эринги","eringi","nấm đùi gà","เห็ดออรินจิ","เห็ดนางรมหลวง","杏鲍菇"],
 "shimeji":["шимиджи","shimeji","shime ji","beech mushroom","nấm hải sản","เห็ดชิเมจิ"],"wood_ear":["муэр","wood ear","black jelly mushroom","древесный гриб","ағаш саңырауқұлағы","เห็ดหูหนู"],"snow_fungus":["серебряное ухо","snow fungus","silver mushroom"],
