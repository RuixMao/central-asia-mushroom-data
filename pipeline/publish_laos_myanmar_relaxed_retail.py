...
ROWS += [
 ...
 ("MM","Yangon","Go Green Myanmar / foodpanda","Mushroom 200g / 蘑菇","unspecified_mushroom","fresh","200g",3300,None,200,"https://www.foodpanda.com.mm/en/shop/s5kk/go-green-myanmar","A","商品页有图片，但公开原图受访问限制且名称仅为 Mushroom，无法可靠识别具体菌种"),
 ...
 ("MM","Yangon","Kaung Food Streat / foodpanda","Stir Fried Water Spinach with Mushroom / 菌菇炒空心菜","unspecified_mushroom","prepared_food","1份（页面未标重量）",6000,None,None,"https://www.foodpanda.com.mm/en/restaurant/ms7x/kaung-food-streat","A","菜品页有图片，但公开原图受访问限制且成菜外观不足以可靠识别；未折算"),
 ...
 ("MM","Yangon","Together Food & BBQ / foodpanda","Stir Fried Water Spinach with Mushroom / 菌菇炒空心菜","unspecified_mushroom","prepared_food","1份（页面未标重量）",6500,None,None,"https://www.foodpanda.com.mm/en/restaurant/s2hn/together-food-and-bbq","A","菜品页有图片；同店另售金针菇不能证明本菜品所用品种，故不据此推定；未折算"),
 ...
 ("MM","Yangon","Green Mala / foodpanda","Stir Fried Water Spinach with Mushroom / 菌菇炒空心菜","unspecified_mushroom","prepared_food","1份（页面未标重量）",4500,None,None,"https://www.foodpanda.com.mm/en/restaurant/k7pp/cim-ln-ciup-e-maalaahng-chiung","A","菜品页有图片，但公开原图受访问限制且成菜外观不足以可靠识别；未折算"),
